...
-- -----------------------------------------------------
-- Table `panda`.`CharacterList`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `panda`.`CharacterList` (
...
CREATE TABLE IF NOT EXISTS `panda`.`isPlaying` (
  ...
  CONSTRAINT `fk_isPlaying_Character1`
    ...
    REFERENCES `panda`.`CharacterList` (`idCharacter`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
INSERT INTO CharacterList (name) VALUES ("ralph1");
INSERT INTO CharacterList (name) VALUES ("vehicle1");
INSERT INTO CharacterList (name) VALUES ("panda1");
